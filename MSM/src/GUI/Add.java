...
public class Add extends JPanel {
    ...
    public void north() {
        ...
        dayChooser.setSelectedIndex(LocalDate.now().getDayOfMonth() - 1);
        ...
        monthChooser.setSelectedIndex(LocalDate.now().getMonthValue() - 1);
        ...
        yearChooser.setSelectedItem(LocalDate.now().getYear());
    ...
    private void south() {
        ...
        addBorder = new RadiusPanel(45, 3, new Color(200, 200, 200, 0), new Color[]{
            new Color(6, 236, 254, 175),
            new Color(6, 254, 151, 175),
            new Color(6, 254, 6, 175),});
        addBorder.setPreferredSize(new Dimension(140, 60));
    ...
    public RadiusPanel getAddBorder() {
        return addBorder;
    }
    ...
    // Setter
    public void setDayChooser(JComboBox<Integer> dayChooser) {
